        ...
        <div class="left-container container" style="margin-left: -70px;">
            <div class="menu-box block"> <!-- MENU BOX (LEFT-CONTAINER) -->
                ...
                <ul class="menu-box-menu">
                    ...
                    <li>
                        <a class="menu-box-tab" href="track-order.php" target="blank"><span class="icon entypo-location scnd-font-color"></span>Track Order</a>
                    </li>
                    <li>
            ...
            <div class="middle-container container" style="margin-left: 380px; margin-top: -380px;">
                <div class="profile block"> <!-- PROFILE (MIDDLE-CONTAINER) -->
                    ...
                    <div class="profile-picture big-profile-picture clear">
                        <img width="150px" alt="user-profile" src="img/profile.png">
                    </div>
                                       <div class="profile-description">
                        <p class="scnd-font-color">Welcome To Kanku ! </p>
                    </div>
                    <a class="subscribe button" href="logout.php" style="color: white">LOG OUT</a>
                    <a class="subscribe button" href=" edit-profile.php" style="color: white">EDIT PROFILE</a>
                </div>
                <!-- RIGHT-CONTAINER -->
